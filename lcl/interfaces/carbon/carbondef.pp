{ $Id: carbondef.pp 21280 2009-08-18 14:44:25Z sekelsenmat $
                    -----------------------------------------
                    carbondef.pp  -  Type & Const definitions
                    -----------------------------------------

 @created(Wed Aug 26st WET 2005)
 @lastmod($Date: 2009-08-18 16:44:25 +0200 (Tue, 18 Aug 2009) $)
...
var
  R: TRect;
begin
  if not Resizing and not (csAlignmentNeeded in LCLObject.ControlState) then
  begin
    GetBounds(R);
