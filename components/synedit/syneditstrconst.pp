...
$Id: syneditstrconst.pp 21053 2009-08-01 10:48:48Z martin $
...
//  SYNS_ScrollInfoFmt            =  'Top Line: %d';
  ...
  SYNS_FilterCPP                =  'C++ Files (*.c,*.cpp,*.h,*.hpp,*.hh)|*.c;*.cpp;*.cxx;*.h;*.hpp;*.hxx;*.hh';
  ...
  SYNS_FilterX86Asm             =  'x86 Assembly Files (*.asm,*.inc)|*.asm;*.inc';
