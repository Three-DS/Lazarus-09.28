{  $Id: registersynedit.pas 21429 2009-08-23 20:02:29Z vincents $  }
{
 /***************************************************************************
                           registersynedit.pas
                           -------------------
...
uses
  ...
  SynHighlighterSQL, SynHighlighterPython, SynHighlighterVB, SynHighlighterAsm,  SynHighlighterAny,
...
procedure RegisterSynHighlighterAsm;
begin
  RegisterComponents('SynEdit',[TSynAsmSyn]);
end;
...
begin
  ...
  RegisterUnit('SynHighlighterAsm',@RegisterSynHighlighterAsm);
